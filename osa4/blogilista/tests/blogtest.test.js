...
describe('Most blogs', () => {
    ...
    test('One blog', () => {
        ...
        expect(listHelper.mostBlogs(oneBlog)).toEqual({author:'Testi henkilö', blogs: 1})
    })

    test('Has multiple blogs', ()=>{
        expect(listHelper.mostBlogs(multipleBlogs)).toEqual({author:'Testi henkilö1', blogs: 2})
    })

    test('Multiple most blogs', () => {
        expect(listHelper.mostBlogs(multipleMostBlogs)).toEqual({author:'Testi henkilö1', blogs: 2})
    })
})
////MOST BLOGS//////////////////////////////////////
...
describe('Most Likes', () => {
    ...
    test('One blog', () => {
        expect(listHelper.mostLikes(oneBlog)).toEqual({author:'Testi henkilö', likes: 1})
    })

    test('Has multiple blogs', ()=>{
        expect(listHelper.mostLikes(multipleBlogs)).toEqual({author:'Testi henkilö1', likes: 3})
    })
    test('Multiple most Likes', () => {
        expect(listHelper.mostLikes(multipleMostLikes)).toEqual({author:'Testi henkilö1', likes: 6})
    })
})
////MOST LIKES//////////////////////////////////////